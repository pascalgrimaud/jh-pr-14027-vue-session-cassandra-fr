    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/cass-bank-account-my-suffix">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.cassBankAccountMySuffix')">Cass Bank Account</span>
          </b-dropdown-item>
          <b-dropdown-item to="/cass-test-entity">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.cassTestEntity')">Cass Test Entity</span>
          </b-dropdown-item>
          <b-dropdown-item to="/cass-test-mapstruct-entity">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.cassTestMapstructEntity')">Cass Test Mapstruct Entity</span>
          </b-dropdown-item>
          <b-dropdown-item to="/cass-test-service-class-entity">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.cassTestServiceClassEntity')">Cass Test Service Class Entity</span>
          </b-dropdown-item>
          <b-dropdown-item to="/cass-test-service-impl-entity">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.cassTestServiceImplEntity')">Cass Test Service Impl Entity</span>
          </b-dropdown-item>

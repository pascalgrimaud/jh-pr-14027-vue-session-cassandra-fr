...
new Vue({
  ...
  provide: {
    ...
    cassBankAccountService: () => new CassBankAccountMySuffixService(),
    cassTestEntityService: () => new CassTestEntityService(),
    cassTestMapstructEntityService: () => new CassTestMapstructEntityService(),
    cassTestServiceClassEntityService: () => new CassTestServiceClassEntityService(),
    cassTestServiceImplEntityService: () => new CassTestServiceImplEntityService(),

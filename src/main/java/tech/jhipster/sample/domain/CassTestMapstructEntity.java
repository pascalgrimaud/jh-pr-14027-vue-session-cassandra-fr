...
/**
 * A CassTestMapstructEntity.
 */
@Table("cassTestMapstructEntity")
public class CassTestMapstructEntity implements Serializable {
    ...
    public CassTestMapstructEntity id(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CassTestMapstructEntity stringField(String stringField) {
    ...
    public CassTestMapstructEntity stringRequiredField(String stringRequiredField) {
    ...
    public CassTestMapstructEntity stringMinlengthField(String stringMinlengthField) {
    ...
    public CassTestMapstructEntity stringMaxlengthField(String stringMaxlengthField) {
    ...
    public CassTestMapstructEntity stringPatternField(String stringPatternField) {
    ...
    public CassTestMapstructEntity integerField(Integer integerField) {
    ...
    public CassTestMapstructEntity integerRequiredField(Integer integerRequiredField) {
    ...
    public CassTestMapstructEntity integerMinField(Integer integerMinField) {
    ...
    public CassTestMapstructEntity integerMaxField(Integer integerMaxField) {
    ...
    public CassTestMapstructEntity longField(Long longField) {
    ...
    public CassTestMapstructEntity longRequiredField(Long longRequiredField) {
    ...
    public CassTestMapstructEntity longMinField(Long longMinField) {
    ...
    public CassTestMapstructEntity longMaxField(Long longMaxField) {
    ...
    public CassTestMapstructEntity floatField(Float floatField) {
    ...
    public CassTestMapstructEntity floatRequiredField(Float floatRequiredField) {
    ...
    public CassTestMapstructEntity floatMinField(Float floatMinField) {
    ...
    public CassTestMapstructEntity floatMaxField(Float floatMaxField) {
    ...
    public CassTestMapstructEntity doubleRequiredField(Double doubleRequiredField) {
    ...
    public CassTestMapstructEntity doubleMinField(Double doubleMinField) {
    ...
    public CassTestMapstructEntity doubleMaxField(Double doubleMaxField) {
    ...
    public CassTestMapstructEntity bigDecimalRequiredField(BigDecimal bigDecimalRequiredField) {
    ...
    public CassTestMapstructEntity bigDecimalMinField(BigDecimal bigDecimalMinField) {
    ...
    public CassTestMapstructEntity bigDecimalMaxField(BigDecimal bigDecimalMaxField) {
    ...
    public CassTestMapstructEntity localDateField(LocalDate localDateField) {
    ...
    public CassTestMapstructEntity localDateRequiredField(LocalDate localDateRequiredField) {
    ...
    public CassTestMapstructEntity instantDateField(Instant instantDateField) {
    ...
    public CassTestMapstructEntity instantRequiredField(Instant instantRequiredField) {
    ...
    public CassTestMapstructEntity zonedDateTimeField(ZonedDateTime zonedDateTimeField) {
    ...
    public CassTestMapstructEntity zonedDateTimeRequiredField(ZonedDateTime zonedDateTimeRequiredField) {
    ...
    public CassTestMapstructEntity durationDateField(Duration durationDateField) {
    ...
    public CassTestMapstructEntity durationRequiredField(Duration durationRequiredField) {
    ...
    public CassTestMapstructEntity booleanField(Boolean booleanField) {
    ...
    public CassTestMapstructEntity booleanRequiredField(Boolean booleanRequiredField) {
    ...
    public CassTestMapstructEntity enumTom(EnumFieldClass enumTom) {
    ...
    public CassTestMapstructEntity enumRequiredTom(EnumRequiredFieldClass enumRequiredTom) {
    ...
    public CassTestMapstructEntity picture(ByteBuffer picture) {
    ...
    public CassTestMapstructEntity pictureContentType(String pictureContentType) {
    ...
    public CassTestMapstructEntity operationsFile(ByteBuffer operationsFile) {
    ...
    public CassTestMapstructEntity operationsFileContentType(String operationsFileContentType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CassTestMapstructEntity)) {
            return false;
        }
        return id != null && id.equals(((CassTestMapstructEntity) o).id);
    }

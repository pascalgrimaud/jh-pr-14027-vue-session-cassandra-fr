...
/**
 * A CassTestServiceClassEntity.
 */
@Table("cassTestServiceClassEntity")
public class CassTestServiceClassEntity implements Serializable {
    ...
    public CassTestServiceClassEntity id(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CassTestServiceClassEntity stringField(String stringField) {
    ...
    public CassTestServiceClassEntity stringRequiredField(String stringRequiredField) {
    ...
    public CassTestServiceClassEntity stringMinlengthField(String stringMinlengthField) {
    ...
    public CassTestServiceClassEntity stringMaxlengthField(String stringMaxlengthField) {
    ...
    public CassTestServiceClassEntity stringPatternField(String stringPatternField) {
    ...
    public CassTestServiceClassEntity integerField(Integer integerField) {
    ...
    public CassTestServiceClassEntity integerRequiredField(Integer integerRequiredField) {
    ...
    public CassTestServiceClassEntity integerMinField(Integer integerMinField) {
    ...
    public CassTestServiceClassEntity integerMaxField(Integer integerMaxField) {
    ...
    public CassTestServiceClassEntity longField(Long longField) {
    ...
    public CassTestServiceClassEntity longRequiredField(Long longRequiredField) {
    ...
    public CassTestServiceClassEntity longMinField(Long longMinField) {
    ...
    public CassTestServiceClassEntity longMaxField(Long longMaxField) {
    ...
    public CassTestServiceClassEntity floatField(Float floatField) {
    ...
    public CassTestServiceClassEntity floatRequiredField(Float floatRequiredField) {
    ...
    public CassTestServiceClassEntity floatMinField(Float floatMinField) {
    ...
    public CassTestServiceClassEntity floatMaxField(Float floatMaxField) {
    ...
    public CassTestServiceClassEntity doubleRequiredField(Double doubleRequiredField) {
    ...
    public CassTestServiceClassEntity doubleMinField(Double doubleMinField) {
    ...
    public CassTestServiceClassEntity doubleMaxField(Double doubleMaxField) {
    ...
    public CassTestServiceClassEntity bigDecimalRequiredField(BigDecimal bigDecimalRequiredField) {
    ...
    public CassTestServiceClassEntity bigDecimalMinField(BigDecimal bigDecimalMinField) {
    ...
    public CassTestServiceClassEntity bigDecimalMaxField(BigDecimal bigDecimalMaxField) {
    ...
    public CassTestServiceClassEntity localDateField(LocalDate localDateField) {
    ...
    public CassTestServiceClassEntity localDateRequiredField(LocalDate localDateRequiredField) {
    ...
    public CassTestServiceClassEntity instantDateField(Instant instantDateField) {
    ...
    public CassTestServiceClassEntity instantRequiredField(Instant instantRequiredField) {
    ...
    public CassTestServiceClassEntity zonedDateTimeField(ZonedDateTime zonedDateTimeField) {
    ...
    public CassTestServiceClassEntity zonedDateTimeRequiredField(ZonedDateTime zonedDateTimeRequiredField) {
    ...
    public CassTestServiceClassEntity durationDateField(Duration durationDateField) {
    ...
    public CassTestServiceClassEntity durationRequiredField(Duration durationRequiredField) {
    ...
    public CassTestServiceClassEntity booleanField(Boolean booleanField) {
    ...
    public CassTestServiceClassEntity booleanRequiredField(Boolean booleanRequiredField) {
    ...
    public CassTestServiceClassEntity enumTom(EnumFieldClass enumTom) {
    ...
    public CassTestServiceClassEntity enumRequiredTom(EnumRequiredFieldClass enumRequiredTom) {
    ...
    public CassTestServiceClassEntity picture(ByteBuffer picture) {
    ...
    public CassTestServiceClassEntity pictureContentType(String pictureContentType) {
    ...
    public CassTestServiceClassEntity operationsFile(ByteBuffer operationsFile) {
    ...
    public CassTestServiceClassEntity operationsFileContentType(String operationsFileContentType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CassTestServiceClassEntity)) {
            return false;
        }
        return id != null && id.equals(((CassTestServiceClassEntity) o).id);
    }

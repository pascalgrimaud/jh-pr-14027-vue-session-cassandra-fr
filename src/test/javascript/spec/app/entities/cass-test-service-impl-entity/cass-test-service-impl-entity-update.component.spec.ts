...
import CassTestServiceImplEntityUpdateComponent from '@/entities/cass-test-service-impl-entity/cass-test-service-impl-entity-update.vue';
import CassTestServiceImplEntityClass from '@/entities/cass-test-service-impl-entity/cass-test-service-impl-entity-update.component';
...
describe('Component Tests', () => {
  describe('CassTestServiceImplEntity Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<CassTestServiceImplEntityClass>(CassTestServiceImplEntityUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        comp.cassTestServiceImplEntity = entity;
        cassTestServiceImplEntityServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(cassTestServiceImplEntityServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.cassTestServiceImplEntity = entity;
        cassTestServiceImplEntityServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(cassTestServiceImplEntityServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        cassTestServiceImplEntityServiceStub.retrieve.resolves([foundCassTestServiceImplEntity]);

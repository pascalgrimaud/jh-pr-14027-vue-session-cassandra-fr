...
import { CassTestServiceImplEntity } from '@/shared/model/cass-test-service-impl-entity.model';
...
describe('Service Tests', () => {
  describe('CassTestServiceImplEntity Service', () => {
    let service: CassTestServiceImplEntityService;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new CassTestServiceImplEntityService();
      currentDate = new Date();
      elemDefault = new CassTestServiceImplEntity(
        'ID',
        'AAAAAAA',
        'AAAAAAA',
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a CassTestServiceImplEntity', async () => {
        const returnedFromService = Object.assign(
          {
            id: 'ID',
            localDateField: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a CassTestServiceImplEntity', async () => {
      ...
      it('should update a CassTestServiceImplEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
      ...
      it('should not update a CassTestServiceImplEntity', async () => {
      ...
      it('should return a list of CassTestServiceImplEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
            stringRequiredField: 'BBBBBB',
      ...
      it('should not return a list of CassTestServiceImplEntity', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a CassTestServiceImplEntity', async () => {
      ...
      it('should not delete a CassTestServiceImplEntity', async () => {

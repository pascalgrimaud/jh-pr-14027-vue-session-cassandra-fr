...
import { CassTestServiceClassEntity } from '@/shared/model/cass-test-service-class-entity.model';
...
describe('Service Tests', () => {
  describe('CassTestServiceClassEntity Service', () => {
    let service: CassTestServiceClassEntityService;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new CassTestServiceClassEntityService();
      currentDate = new Date();
      elemDefault = new CassTestServiceClassEntity(
        'ID',
        'AAAAAAA',
        'AAAAAAA',
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a CassTestServiceClassEntity', async () => {
        const returnedFromService = Object.assign(
          {
            id: 'ID',
            localDateField: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a CassTestServiceClassEntity', async () => {
      ...
      it('should update a CassTestServiceClassEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
      ...
      it('should not update a CassTestServiceClassEntity', async () => {
      ...
      it('should return a list of CassTestServiceClassEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
            stringRequiredField: 'BBBBBB',
      ...
      it('should not return a list of CassTestServiceClassEntity', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a CassTestServiceClassEntity', async () => {
      ...
      it('should not delete a CassTestServiceClassEntity', async () => {

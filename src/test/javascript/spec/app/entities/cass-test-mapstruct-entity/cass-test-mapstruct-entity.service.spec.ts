...
import { CassTestMapstructEntity } from '@/shared/model/cass-test-mapstruct-entity.model';
...
describe('Service Tests', () => {
  describe('CassTestMapstructEntity Service', () => {
    let service: CassTestMapstructEntityService;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new CassTestMapstructEntityService();
      currentDate = new Date();
      elemDefault = new CassTestMapstructEntity(
        'ID',
        'AAAAAAA',
        'AAAAAAA',
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a CassTestMapstructEntity', async () => {
        const returnedFromService = Object.assign(
          {
            id: 'ID',
            localDateField: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a CassTestMapstructEntity', async () => {
      ...
      it('should update a CassTestMapstructEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
      ...
      it('should not update a CassTestMapstructEntity', async () => {
      ...
      it('should return a list of CassTestMapstructEntity', async () => {
        const returnedFromService = Object.assign(
          {
            stringField: 'BBBBBB',
            stringRequiredField: 'BBBBBB',
      ...
      it('should not return a list of CassTestMapstructEntity', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a CassTestMapstructEntity', async () => {
      ...
      it('should not delete a CassTestMapstructEntity', async () => {
